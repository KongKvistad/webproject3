  ...
  <div class="box" :class="fromHome ? 'w-3/5': 'w-full'">
    <div class="box-wrapper">
      ...
      <div v-else class=" bg-white rounded flex items-center w-full shadow-sm border border-gray-200">
        ...
        <input v-model="searchTerm" v-on:keyup="emitToParent(searchTerm)" name="" id="" @keydown.enter="PLACEHOLDER" placeholder="Search..." class="w-full p-5 pl-4 text-sm outline-none focus:outline-none bg-transparent" autofocus>
